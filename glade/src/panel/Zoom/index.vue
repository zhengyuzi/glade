...
const { setZoom } = inject<ReturnType<typeof useGlade>>('glade')!
...
<template>
  <GladeButtonGroup>
    <GladeButton class="px-4" :disabled="!canZoomOut" @click="zoomOut">
      <i className="i-material-symbols-remove-rounded" />
    </GladeButton>
    <GladeButton class="w-45px text-sm" @click="reset">
      {{ zoom }}%
    </GladeButton>
    <GladeButton class="px-4" :disabled="!canZoomIn" @click="zoomIn">
